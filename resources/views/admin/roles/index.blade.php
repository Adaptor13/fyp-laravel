                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input id="role_name" name="name" type="text" class="form-control @error('name') is-invalid @enderror"
    ...
    <script>
        @if ($errors->any())
            document.addEventListener('DOMContentLoaded', function() {
                const modal = new bootstrap.Modal(document.getElementById('addRole'));
                modal.show();
            });
        @endif
